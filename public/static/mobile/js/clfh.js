...
for(i=0;i<22;i++){
	...
	var randdate=parseInt(Math.random()*5+1);	
	...
	quotes[1]='<p>您订购的 <font color="#090">完美容颜装（4周期）</font>  已发货 请注意收货<font color="#FF0000">√</font></p>'

	quotes[2]='<p>您订购的 <font color="#090">逆转肌肤装（3周期）</font>  已发货 请注意收货<font color="#FF0000">√</font></p> '

	quotes[3]='<p>您订购的 <font color="#090">焕颜紧致装（2周期）</font>  已发货 请注意收货<font color="#FF0000">√</font></p>'

	quotes[4]='<p>您订购的 <font color="#090">青春修护装（1周期）</font>  已发货 请注意收货<font color="#FF0000">√</font></p> '
