...
function getHeight(){$1("clfahuo").style.height=$1("clforml").offsetHeight-86+"px";} 
...
//
//	for(var i=0;i<$(".red").find("input[name=product_name]").length;i++){
//        $(".red").find("input[name=product_name]")[i].prop("checked", false);
//	}
//	
//	document.querySelector(qid).checked=true;
//console.log(document.querySelector(qid).checked);
