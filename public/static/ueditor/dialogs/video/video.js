    ...
    /**
     ...
     function checkNum( nodes ) {
      ...
      function getVideoHtml(url){
        ...
        '<section style="text-align:center;"><iframe class="video_iframe"  style="position: relative;z-index:1;height:350px;width:90%"  scrolling="no" src="'+conUrl+'" allowfullscreen="" frameborder="0" ></iframe></section>'+
    ...
    function insertUpload(){
        ...
        if (count) {
           ...
           upload_url = uploadDir + file.url;
            if (upload_url.substr(-4) == '.mp3' || upload_url.substr(-4) == '.m4a' || upload_url.substr(-4) == '.wma'  || upload_url.substr(-4) == '.ogg' || upload_url.substr(-4) == '.amr') {
